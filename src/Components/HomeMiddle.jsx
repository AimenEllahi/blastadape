    ...
    <div className="home-middle w-screen h-[1514px] bg-[#000000] md:-mt-[7%] -mt-[20%] pt-[180px] bg-cover bg-center relative">
      ...
      <div className="home-middle-pcr-wrapper flex justify-center flex-wrap">
        <div className="home-middle-pcr flex justify-center mt-10 ">
          ...
          <div className="home-middle-pcr-captivate w-[40%] md:w-[25vw] md:h-[108px] h-28 shrink-0 justify-center items-center flex text-[#fed501] md:text-[32px] text-lg not-italic font-medium leading-[normal] rounded-[10px] border-t-4 border-t-[#f3d126] border-solid">
            CAPTIVATE
          </div>
          <img src="/img/home-middle-arrow.svg" />
          <div className="home-middle-pcr-reward w-[40%] md:w-[25vw] md:h-[108px] h-28 shrink-0 justify-center items-center flex text-[#fed501] md:text-[32px] text-lg not-italic font-medium leading-[normal] rounded-[10px] border-t-4 border-t-[#f3d126] border-solid">
            REWARD
          </div>
        </div>
      </div>
